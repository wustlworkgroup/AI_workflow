...
Project="10132025_BAM_transfer" #"input by claude code after receiving the task"
csv_file="synapse_annotations.csv" #"input by claude code after receiving the task"
synapse_parent_id="syn70110161" #"input by claude code after receiving the task"
if [ -z "$Project" ]; then
